        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Gambar Produk</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.gambar_produks.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama_gambar') is-invalid @enderror" id="nama_gambar" name="nama_gambar" value="{{ old('nama_gambar') }}" required>
                            @error('nama_gambar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
